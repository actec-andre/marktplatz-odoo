...
async function main() {
  try {
    ...
    const transport = new StdioClientTransport({
      ...
      env: {
        ...process.env,
        MAGENTO_BASE_URL: process.env.MAGENTO_BASE_URL || 'http://165.22.66.230/rest/V1',
        MAGENTO_API_TOKEN: process.env.MAGENTO_API_TOKEN || 'f62nq8643aw7v9nomc07g0g1lyj0afg9'
      }
    });
